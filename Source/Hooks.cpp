...
static bool __STDCALL createMove(void* thisptr, float inputSampleTime, UserCmd* cmd) noexcept
{
...
static void __STDCALL doPostScreenEffects(void* thisptr, void* param) noexcept
{
...
static float __STDCALL getViewModelFov(void* thisptr) noexcept
{
...
static void __STDCALL drawModelExecute(void* thisptr, void* ctx, void* state, const ModelRenderInfo& info, matrix3x4* customBoneToWorld) noexcept
{
...
static void __STDCALL frameStageNotify(void* thisptr, FrameStage stage) noexcept
{
...
static int __STDCALL emitSound(void* thisptr, void* filter, int entityIndex, int channel, const char* soundEntry, unsigned int soundEntryHash, const char* sample, float volume, int seed, int soundLevel, int flags, int pitch, const Vector& origin, const Vector& direction, void* utlVecOrigins, bool updatePositions, float soundtime, int speakerentity, void* soundParams) noexcept
{
...
static bool __STDCALL shouldDrawFog(void* thisptr) noexcept
{
...
static bool __STDCALL shouldDrawViewModel(void* thisptr) noexcept
{
...
static void __STDCALL setDrawColor(void* thisptr, int r, int g, int b, int a) noexcept
{
...
static void __STDCALL overrideView(void* thisptr, ViewSetup* setup) noexcept
{
    if (localPlayer)
    {
...
static int __STDCALL listLeavesInBox(void* thisptr, const Vector& mins, const Vector& maxs, unsigned short* list, int listMax) noexcept
{
...
static void __STDCALL render2dEffectsPreHud(void* thisptr, void* viewSetup) noexcept
{
...
static const DemoPlaybackParameters* __STDCALL getDemoPlaybackParameters(void* thisptr) noexcept
{
...
static bool __STDCALL isPlayingDemo(void* thisptr) noexcept
{
...
static void __STDCALL updateColorCorrectionWeights(void* thisptr) noexcept
{
...
static float __STDCALL getScreenAspectRatio(void* thisptr, int width, int height) noexcept
{
...
static void __STDCALL renderSmokeOverlay(void* thisptr, bool update) noexcept
{
...
static double __STDCALL getArgAsNumber(void* thisptr, void* params, int index) noexcept
{
...
static const char* __STDCALL getArgAsString(void* thisptr, void* params, int index) noexcept
{
...
static bool __STDCALL equipItemInLoadout(void* thisptr, Team team, int slot, std::uint64_t itemID, bool swap) noexcept
{
    InventoryChanger::onItemEquip(team, slot, itemID);
    return hooks->inventoryManager.callOriginal<bool, 20>(team, slot, itemID, swap);
}

static void __STDCALL soUpdated(void* thisptr, SOID owner, SharedObject* object, int event) noexcept
{
